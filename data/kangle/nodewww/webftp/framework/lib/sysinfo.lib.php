...
function sys_linux()
{
	...
	if ($diskTotal !== false && $diskFree !== false && $diskTotal > 0) {
		...
		$res['diskTotal'] = round($diskTotal / 1024 / 1024, 2);
		$res['diskFree'] = round($diskFree / 1024 / 1024, 2);
		$res['diskUsed'] = round($diskUsed / 1024 / 1024, 2);
		$res['diskPct'] = round($diskUsed / $diskTotal * 100, 2);
	}
	else {
		$res['diskTotal'] = 0;
		$res['diskFree'] = 0;
