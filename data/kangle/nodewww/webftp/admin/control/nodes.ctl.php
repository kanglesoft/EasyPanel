...
class NodesControl extends Control
{
	...
	public function editForm()
	{
		...
		// CLI 只取主容器内置的 php7.4；额外容器版本无容器内 CLI
		$phpcli_versions = array();
		if (isset($phpversions['php74'])) {
			$phpcli_versions['php74'] = $phpversions['php74'];
		}

		$this->_tpl->assign('view_dir_count', $view_dir_count);
		$this->_tpl->assign('view_dir', $view_dir);
		$this->_tpl->assign('phpversions', $phpversions);
		$this->_tpl->assign('phpcli_versions', $phpcli_versions);
