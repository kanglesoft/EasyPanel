...
class BackupControl extends control
{
	...
	public function restore()
	{
		...
		$backup_dir = !empty($setting['backup_dir']) ? $setting['backup_dir'] : '/backup/';
		...
		if ($setting['backup_save_place'] == 'r') {
			...
			$listdir = apicall('restore', 'listLocalDirFile', array($backup_dir));
		}
		...
		$this->_tpl->assign('backup_dir', $backup_dir);
		$this->_tpl->assign('backup_save_place', $setting['backup_save_place']);
